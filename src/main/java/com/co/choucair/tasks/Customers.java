...
public class Customers implements Task {
    ...
    public Customers(UserLoombokData userLoombokData) {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitUntil.the(NewCustomerPage.TXT_CUSTOMER_ID, isVisible()).forNoMoreThan(10).seconds(),
               ...
               WaitUntil.the(CustomersPage.TXT_VALIDATION_CUSTOMER, isVisible()).forNoMoreThan(10).seconds()
        );
    }



    public static Customers onTheSite(UserLoombokData userLoombokData){
        return Instrumented.instanceOf(Customers.class).withProperties(userLoombokData);
    }
